        ...
        <header className="header">
            <nav className="header__container container">
                <div className="header__left-content">
                    <h1 className="header-cursive margin-reset"><a className="link" href="index.html">Studio</a></h1>
                    <ul className="header__section-list u-list">
                        <li><a className="link" href="#1">Individuals</a></li>
                        <li><a className="link" href="#1">Companies</a></li>
                        <li><a className="link" href="#1">The Studio</a></li>
                        <li><a className="link" href="#1">About Us</a></li>
                        <li><a className="link" href="#1">Blog</a></li>
                    </ul>
                </div>
                <div className="header__right-content">
                    <a className="header__btn button link" href="##">Book Now</a>
