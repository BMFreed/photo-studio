            ...
            <div className="more-info__container container">
                <div className="more-info__top-content">
                    <section className="more-info__headshots">
                        <h3 className="more-info__headshots-header header-secondary margin-reset">Why are headshots important?</h3>
                    ...
                    <section className="more-info__tips">
                        <h3 className="more-info__tips-header header-cursive margin-reset">5 Useful Tips</h3>
                        <ul className="more-info__tip-list u-list">
                            <li className="more-info__tip">
                                ...
                                <span className="more-info__tip-caption">Go professional, it’s worth it, because cheap looks cheap.</span>
                            </li>
                            <li className="more-info__tip">
                                <img src={process.env.PUBLIC_URL + "/img/tips/mirror_icon_11822.png"} alt="Tip" />
                                <span className="more-info__tip-caption">Make sure it looks like you, not like you want to be.</span>
                            </li>
                            <li className="more-info__tip">
                                <img src={process.env.PUBLIC_URL + "/img/tips/eyes_icon_11817.png"} alt="Tip" />
                                <span className="more-info__tip-caption">It’s all about the eyes and what’s behind them.</span>
                            </li>
                            <li className="more-info__tip">
                                <img src={process.env.PUBLIC_URL + "/img/tips/studio_icon_11812.png"} alt="Tip" />
                                <span className="more-info__tip-caption">Control framing, lighting &amp; background.</span>
                            </li>
                            <li className="more-info__tip more-info__tip_move-right">
                                ...
                                <span className="more-info__tip-caption">Stay chill with clothing &amp; makeup, you must be you.</span>
                            </li>
                        </ul>
                    </section>
                </div>
                <div className="more-info__bottom-content">
                    <section className="more-info__headshot-services">
                        <h3 className="more-info__bottom-title margin-reset">Professional Headshot Services</h3>
